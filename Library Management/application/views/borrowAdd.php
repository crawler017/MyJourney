   ...
   <script src="/Shoot_Idiot/public/bootstrap-datetimepicker-master/bootstrap-datetimepicker-master/sample in bootstrap v3/jquery/jquery-1.8.3.min.js"></script>
    ...
    <script type="text/javascript">
        function checkForm()
        {
            ...
            if(regex.test(num)||num.length==0)//同上述内容
            {
                alert("借记人学号不能为空！");
                return false;
            }
   ...
   <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list">
                ...
                <a class="crumb-name" href="<?php echo site_url('BorrowList/borrow'); ?>">在借列表</a>
                <span class="crumb-step">&gt;</span>
                <span>借书登记</span>
            </div>
        </div>
       <div class="result-wrap">
           <div class="result-content">
               ...
               <form action="<?php echo site_url('BorrowAdd/borrowAd'); ?>" method="post" id="myform" name="myform" enctype="multipart/form-data" onsubmit="return checkForm()"/>
