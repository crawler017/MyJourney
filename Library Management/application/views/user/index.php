	...
	<div class="container clearfix">
		...
		<div class="main-wrap">
			...
			<div class="crumb-wrap">
                ...
                <span class="crumb-step"></span><a class="crumb-name" >首页</a>
				</div>
			</div>
					...
					<div class="result-content">
						<table id=grid
							...
							<tbody>
                                ...
                                $sql = 'select * from sso_request order by flow_id asc';
                                //var_dump($sql);die;
                                // 结果集
                                ...
                                for($i=0; $i<$Num; $i++) {
                                    ...
                                    echo "<td>
                                     <a href='javascript:log({$row['flow_id']})'>请求登录</a>
                                     </td>";
                                    echo"<td>";
                                }
                                // 5. 释放结果集
                            ...
                            <script type="text/javascript">
                                 function log (flow_id) {
                                    if (confirm("确定要登录吗？")){
                                        window.location.href = "<?php echo site_url('Login/jump'); ?>" + '/' + flow_id;
                                    }
                                }
                            </script>
</div>
