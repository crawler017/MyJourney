		...
		<div class="main-wrap">
			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					...
					<a class="crumb-name" href="<?php echo site_url('BorrowAdd/borrowA'); ?>">借书登记</a>
					<span class="crumb-step">></span>
					<span>在借列表</span>
				</div>
			</div>
			...
			<div class="result-wrap">
                    ...
                    <div class="result-list">
                        <a href="<?php echo site_url('BorrowAdd/borrowA'); ?>"><i class="icon-font"></i>借书登记</a>
                ...
                <div class="result-content">
						<table id=grid
							...
							<tbody>
                                ...
                                $sql = 'select * from borrow order by id asc';
                                //var_dump($sql);die;
                                // 结果集
                            ...
                            <script type="text/javascript">
                                 function del (id) {
                                    if (confirm("确定删除吗？")){
                                        window.location.href="<?php echo site_url('BorrowList/borrowDel'); ?>?id="+id;
                                    }
                                }
                            </script>
					</form>
