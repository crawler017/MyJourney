                ...
                <form action="#" method="post">
                    <table class="search-tab">
                        <tr>
                            ...
                            <th width="70">学号:</th>
                            <td><input class="common-text"type="text"></td>
			...
			<div class="result-wrap">
					...
					<form id="customerForm" name="customerForm" action="#" method=post >
                        ...
                        <div class="result-list">
                            <a href="<?php echo site_url('BlackAdd/blackA'); ?>"><i class="icon-font"></i>新增</a>
                        </div>
                        </div>
					...
					<div class="result-content">
						<table id=grid
							...
							<tbody>
                                ...
                                // 3. 从DBNAME中查询到blacklist数据库，返回数据库结果集,并按照addtime降序排列
                                ...
                                // 解析结果集,$row为黑名单所有数据，$blackNum为黑名单数目
                                $blacklistNum=mysqli_num_rows($result);
                            ...
                            <script type="text/javascript">
                                 function del (id) {
                                    if (confirm("确定删除吗？")){
                                        window.location.href="<?php echo site_url('BlackList/blackDel'); ?>?id="+id;
                                    }
                                }
                            </script>
                            <script type="text/javascript">
                                function edit (id) {
                                    if(confirm("确定修改此名单吗？")){
                                        window.location.href="<?php echo site_url('BlackList/preEd'); ?>" + '/' + id;
                                    }
                                }
                            </script>
                    </div>
