...
<html lang="zh-CN">
    ...
    <body>
        ...
        <form action="${pageContext.request.contextPath}/updateUserServlet" method="post" id="update">
            <!--  隐藏域 提交id-->
          ...
          <div class="form-group">
            ...
            <input type="text" id="email" class="form-control" value="${user.email}" name="email" placeholder="请输入邮箱号"/>
          </div>
